...
interface AppState {
  ...
  banUserAndRejectApplication: (appId: string, email: string) => void;
...
export function AppProvider({ children }: { children: ReactNode }) {
   ...
   * and automatically discharges the target application request.
   */
  const banUserAndRejectApplication = useCallback((appId: string, email: string) => {
    ...
    setApplicationQueue((prevQueue) => {
      ...
      // Filter out application request or update state dynamically across matching users
